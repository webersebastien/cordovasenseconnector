 ...
 */
- (void)streamConnectionWithService:(NSString *)service data:(NSData *)data withResponseBlock:(SFKStreamConnectionResponseBlock)responseBlock errorBlock:(SFKErrorBlock)errorBlock __attribute__((deprecated("first deprecated in SENSE 3.7 - Use NSURLConnection or NSURLSession requests")));
